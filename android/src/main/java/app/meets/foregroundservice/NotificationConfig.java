...
class NotificationConfig {
    ...
    private static final String KEY_CHANNEL_NAME = "app.meets.foregroundservice.notification_channel_name";
    private static final String KEY_CHANNEL_DESCRIPTION = "app.meets.foregroundservice.notification_channel_description";
    private static final String KEY_NOTIFICATION_COLOR = "app.meets.foregroundservice.notification_color";
    ...
    public String getChannelName() {
        ...
        // Default
        return "app.meets.foregroundservice";
    }
